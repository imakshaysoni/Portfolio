...
import optionProject from "../../public/images/projects/BankNiftyOption.jpg";
      ...
      <main className="w-ful mb-16 flex flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          ...
          <div className="grid grid-col-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                title="Excelidraw System Design Diagrams"
                img={design}
                link="https://github.com/imakshaysoni/ExcaliDraw-Diagrams"
            ...
            {/* <div className='col-span-6 sm:col-span-12'>
                <Project 
                    ...
                    img={project1}
                    link="https://github.com/imakshaysoni"
                    github="https://github.com/imakshaysoni"
                    type="Project-1"
